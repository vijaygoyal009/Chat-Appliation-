...
#             # Agar user authenticated nahi hai, connection close kar do
#             await self.close()
#         else:
#             # Chat room join karein
...
#         # Message ko room group mein broadcast karein (with user info)
#         await self.channel_layer.group_send(
#             self.room_group_name,
#             {
#                 'type': 'chat_message',
#                 'message': message,
#                 'user': user.username  # Send user's name
#             }
#         )
...
#         user = event['user']  # User name from the event

#         # Message ko WebSocket par send karein (with user info)
#         await self.send(text_data=json.dumps({
#             'message': message,
#             'user': user  # Send user's name to frontend
#         }))
